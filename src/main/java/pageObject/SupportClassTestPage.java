...
By messageLocator=By.id("message");
    ...
    public SupportClassTestPage(WebDriver driver) {
        this.driver = driver;
    ...
    public void selectSingleOptionMessage(final String singleOptionText){
        WebElement singleSelectMenu=wait.until(
                ExpectedConditions.visibilityOfElementLocated(selectMenuLocator)
        );
    ...
    public void waitForMessageReceived(){
        ...
        wait.until(ExpectedConditions.textMatches(messageLocator, Pattern.compile("\\S")));
    }
}
